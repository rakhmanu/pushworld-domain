...
#the loop
for obs in range(min_obstacle,max_obstacle):
    for repeat in range(n_repeat):
        ...
        out_path = "/Users/ulzhalgasrakhman/sketch-learner/learning/benchmarks/simpler-pushworld/instances"    
            # Generate problem.pddl filename
        pddl_filename = os.path.join(out_path, f"problem_{repeat+1}_{grid_S}_{grid_N}.pddl")
